...
(function (vision_v1p2beta1) {
    ...
    var Resource$Files = /** @class */ (function () {
        ...
        Resource$Files.prototype.asyncBatchAnnotate = function (paramsOrCallback, optionsOrCallback, callback) {
    ...
    var Resource$Images = /** @class */ (function () {
        ...
        Resource$Images.prototype.annotate = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
