...
(function (cloudtrace_v2) {
    ...
    var Resource$Projects$Traces = /** @class */ (function () {
        ...
        Resource$Projects$Traces.prototype.batchWrite = function (paramsOrCallback, optionsOrCallback, callback) {
    ...
    var Resource$Projects$Traces$Spans = /** @class */ (function () {
        ...
        Resource$Projects$Traces$Spans.prototype.createSpan = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
