...
(function (videointelligence_v1) {
    ...
    var Resource$Operations = /** @class */ (function () {
        ...
        Resource$Operations.prototype.cancel = function (paramsOrCallback, optionsOrCallback, callback) {
        ...
        Resource$Operations.prototype.delete = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    var Resource$Videos = /** @class */ (function () {
        ...
        Resource$Videos.prototype.annotate = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
