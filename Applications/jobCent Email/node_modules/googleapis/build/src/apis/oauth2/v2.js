...
(function (oauth2_v2) {
    ...
    var Oauth2 = /** @class */ (function () {
        ...
        Oauth2.prototype.getCertForOpenIdConnect = function (paramsOrCallback, optionsOrCallback, callback) {
        ...
        Oauth2.prototype.tokeninfo = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    var Resource$Userinfo = /** @class */ (function () {
        ...
        Resource$Userinfo.prototype.get = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
    ...
    var Resource$Userinfo$V2$Me = /** @class */ (function () {
        ...
        Resource$Userinfo$V2$Me.prototype.get = function (paramsOrCallback, optionsOrCallback, callback) {
            var params = (paramsOrCallback || {});
            var options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
                callback = paramsOrCallback;
