...
export declare namespace firestore_v1beta1 {
     ...
     */
    interface Schema$ListIndexesResponse {
        /**
         * The indexes.
         */
    ...
    class Resource$Projects$Databases$Indexes {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Projects$Databases$Indexes$Create, options?: MethodOptions): AxiosPromise<Schema$Operation>;
        create(params: Params$Resource$Projects$Databases$Indexes$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Databases$Indexes$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Projects$Databases$Indexes$Get, options?: MethodOptions): AxiosPromise<Schema$Index>;
        get(params: Params$Resource$Projects$Databases$Indexes$Get, options: MethodOptions | BodyResponseCallback<Schema$Index>, callback: BodyResponseCallback<Schema$Index>): void;
        get(params: Params$Resource$Projects$Databases$Indexes$Get, callback: BodyResponseCallback<Schema$Index>): void;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Databases$Indexes$List, options?: MethodOptions): AxiosPromise<Schema$ListIndexesResponse>;
        list(params: Params$Resource$Projects$Databases$Indexes$List, options: MethodOptions | BodyResponseCallback<Schema$ListIndexesResponse>, callback: BodyResponseCallback<Schema$ListIndexesResponse>): void;
        list(params: Params$Resource$Projects$Databases$Indexes$List, callback: BodyResponseCallback<Schema$ListIndexesResponse>): void;
