...
var Generator = /** @class */ (function () {
    ...
    Generator.prototype.hasResourceParam = function (method) {
    ...
    Generator.prototype.generateIndex = function () {
        return __awaiter(this, void 0, void 0, function () {
            var apis, apisPath, indexPath, rootIndexPath, files, _i, files_1, file, filePath, files_2, _a, files_3, version, parts, result, res2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        rootIndexPath = path.join(apisPath, '../', 'index.ts');
                    ...
                    case 7:
                        _b.sent();
                        res2 = this.env.render('root-index.njk', { apis: apis });
                        return [4 /*yield*/, fsp.writeFile(rootIndexPath, res2, { encoding: 'utf8' })];
                    case 8:
                        _b.sent();
                        return [2 /*return*/];
                }
