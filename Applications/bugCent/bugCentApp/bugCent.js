...
const walletsCreated = {
	"bugcent@ncnt.io": true,
	// "af@ncnt.io": true,
	// "jd@ncnt.io": true,
	// "jp@ncnt.io": true,
	// "an@ncnt.io": true,
	// "ag@ncnt.io": true,
	// "fengxyalice@gmail.com": true,
	// "therealmeyer@gmail.com": true,
	// "mkim.don@gmail.com": true,
	// "kk@ncnt.io": true,
	// "bradfgross@gmail.com": true,
	// "mb@ncnt.io": true,
	// "dev@ncnt.io": true,
	// "jdominic@stanford.edu": true,
	// "joeldomjjd@gmail.com": true,
	// "nterns@ncnt.io": true,
	// "anasnicholls@gmail.com": true,
	// "zp@ncnt.io": true
};
...
function initJobCent() {
	return new Promise(function(resolve, reject) {
		return ncentSdkInstance.stampToken('bugcent@ncnt.io', 'bugcent', 1000000, '2021', resolve);
	})
...
// 					if (((headers[idx].value.match(/@/g) || []).length !== 2) && ((headers[idx].value.match(/@/g) || []).length !== 1)) multiTo = true;	
...
module.exports.token_id = token_id;
